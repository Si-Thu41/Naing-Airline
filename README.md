...
**Usage**
Register/Login: Click "Continue with Google" to authenticate
Search Flights: Enter departure city, arrival city, date, and passenger count
View Details: Click on a flight to see more information
Book Flight: Select travel class and proceed to booking
Enter Passenger Info: Fill in details for each passenger
Complete Booking: Review and confirm your booking
View Bookings: Access your booking history from the dashboard
