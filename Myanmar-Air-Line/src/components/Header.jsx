...
function Header({renderHeaderLinks=true,customClass=""}) {
    ...
    return(<div className={`flex justify-between items-center bg-white shadow-md ${customClass}`}>
   
    <nav className="text-left pt-[10px] pl-[20px] mb-[10px] ">
       <img src="naing-high-resolution-logo-transparent.png" alt="Logo" className="w-[100px] inline cursor-pointer" onClick={() => navigate("/")}/>
      {renderHeaderLinks?<>
      ...
      <span className="font-Arial hover:border-b-2 border-orange-700 pb-[10px] pr-[30px] pl-[30px] pt-[10px] cursor-pointer" onClick={()=>navigate("/promotions")}>Promotions</span>
      </>:null
      }
